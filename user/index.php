	...
	<section class="content">
		<div class="container-fluid">
			<div class="row">
						...
						<div class="card-body box-profile">
							...
							<ul class="list-group list-group-unbordered mb-3">
								<li class="list-group-item">
									<b>NIM</b> <a class="float-right"><?php
								...
								<li class="list-group-item">
									...
									$sql = "SELECT username FROM tb_user WHERE nama='$nama'"; 
									$result = mysqli_query($conn, $sql);
									while ($row = $result->fetch_assoc()) {
                ...
                <a href="JavaScript:window.location.href='download.php?file=Pengumuman IOM.pdf';" class="btn btn-primary btn-block"><i class="fas fa-file-pdf"></i>&nbsp<b>Pengumuman IOM.pdf</b></a>
