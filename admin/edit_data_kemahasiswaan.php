  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Akun Kemahasiswaan IOM PNC</h1>
          </div>
          <div class="col-sm-6">
    ...
    <div class="card mb-4"  >
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Edit Kemahasiswaan</h6>
                </div>
                <div class="card-body">
                  ...
                  <input type="hidden" name="id" value="<?= $q["id"];?>">
                    ...
                    <a href="kemahasiswaan.php" class="btn btn-secondary mb-1">Kembali</a><br>
