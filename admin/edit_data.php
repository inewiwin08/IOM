                ...
                <div class="card-body">
                  ...
                  <input type="hidden" name="id" value="<?= $q["id"];?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  required id="nama" name="nama" value="<?= $q["nama"];?>">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">NIM</label>
                      <input type="text" class="form-control" required id="nim" name="nim" value="<?= $q["nim"];?>">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">Email</label>
                      <input type="text" class="form-control" required id="email" name="email" value="<?= $q["email"];?>">
                    </div>
