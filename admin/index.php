...
$mhs = mysqli_query($conn,"SELECT * FROM tb_user");
$kemahasiswaan = mysqli_query($conn,"SELECT * FROM tb_kemahasiswaan");
// menghitung data mobil
$jumlah_mhs = mysqli_num_rows($mhs);
$jumlah_kemahasiswaan = mysqli_num_rows($kemahasiswaan);
...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Admin IOM PNC, <?php echo $_SESSION["username"]; ?></h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo $jumlah_kemahasiswaan; ?></h3>

                <p>Jumlah Akun Kemahasiswaan</p>
              </div>
              <div class="icon">
