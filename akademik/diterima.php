...
$tb_pendaftaran = query("SELECT * FROM tb_pendaftaran WHERE status = 1  ");
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item">
            <a href="diterima.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tabel Diterima Beasiswa IOM PNC</h1>
          </div>
          <div class="col-sm-6">
...

                            {
                                ...
                                "<tr>
                                    ...
                                    <td>
                                          ...
                                          <a href='#' class='btn btn-primary btn-sm'> Diterima</a>
